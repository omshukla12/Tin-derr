...
export function TinderHomepageComponent() {
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-black/95 backdrop-blur-sm">
          <div className="flex flex-col items-center justify-center h-full space-y-8">
            ...
            <Link href="#" className="flex items-center text-2xl font-medium hover:text-pink-300 transition-colors">
